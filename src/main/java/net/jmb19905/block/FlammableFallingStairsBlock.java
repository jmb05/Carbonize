...
public class FlammableFallingStairsBlock extends StairsBlock implements FlammableFaller {

    public FlammableFallingStairsBlock(BlockState state, Settings settings) {
